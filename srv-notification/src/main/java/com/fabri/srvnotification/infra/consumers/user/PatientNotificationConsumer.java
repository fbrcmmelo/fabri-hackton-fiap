...
public class PatientNotificationConsumer implements RabbitMQConsumer {

    private final EmailController emailController;
    private final JsonUtils jsonUtils;

    @Override
    @RabbitListener(queues = FilaConstants.PATIENT_EMAIL_NOTIFICATION)
    public void consume(String message) {
        log.info("srv-notification: Consuming body from patient QUEUE");
